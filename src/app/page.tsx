...
export default function Home() {
  return (
    <div className="flex-1 w-full max-w-2xl mx-auto border-x border-neutral-800 min-h-screen relative flex flex-col">
      {/* Demo Mode Banner - Visible only on Home Feed */}
      <div className="sticky top-0 z-50 bg-brand-accent text-white py-1.5 px-4 text-center text-[10px] md:text-xs font-medium tracking-wide shadow-md">
